...
resp_val_pos = 6; % position in string where the value is 

qns = parseqn('databasename.csv',inf); %last element is number of rows
% "I have a feeling that the choice-to-likert rating function is inside of
%   parseqn.m" - JL
...
for subj = 1:nSub
    ...
    for e = 2:31 % for bis
        ...
        bis_a(e-1,:) = bisans{1}(resp_val_pos);
    end
    bis_a = str2num(bis_a);
    ...
    for f = 2:20 % for ocir
        ...
        ocir_a(f-1,:) = ocirans{1}(resp_val_pos);
    end
    ...
    for g = 2:21 % for zung
        ...
        zung_a(g-1,:) = zungans{1}(resp_val_pos);
    end
    ...
    for h = 2:24 % for schizo
        ...
        schizo1_a(h-1,:) = schizo1ans{1}(resp_val_pos);
    ...
    for i = 2:21
        ...
        schizo2_a(i-1,:) = schizo2ans{1}(resp_val_pos);
    ...
    for j = 2:21 % for anxiety
        ...
        anxiety_a(j-1,:) = anxietyans{1}(resp_val_pos);
    ...
    for k = 2:25 % for leb
        ...
        leb1_a(k-1,:) = leb1ans{1}(resp_val_pos);
    ...
    for l = 2:25
        ...
        leb2_a(l-1,:) = leb2ans{1}(resp_val_pos);
    ...
    for m = 2:9
        ...
        iq1_a(m-1,:) = iq1ans{1}(resp_val_pos);
    ...
    for n = 2:5
        ...
        iq2_a(n-1,:) = iq2ans{1}(resp_val_pos);
    ...
    for o = 2:5
        ...
        iq3_a(o-1,:) = iq3ans{1}(resp_val_pos);
    ...
    for z=2:11
        ...
        alcohol_a(z-1,:) = alcoholans{1}(resp_val_pos);
    end
    ...
    for x=2:27
        ...
        eat_a(x-1,:)=eatans{1}(resp_val_pos);
    end
    ...
    for w=2:19
        ...
        apathy_a(w-1,:)=apathyans{1}(resp_val_pos);
    end
