...
jsPsych.plugins["instructions-faded"] = (function() {

  var plugin = {};

  plugin.info = {
    name: 'instructions-faded',
    description: '',
    parameters: {
      pages: {
      ...
      fade_duration: {
        ...
        default: 1000,
        description: 'How long in milliseconds to fade stimuli.'
      }
    }
  }
  ...
  plugin.trial = function(display_element, trial) {
    ...
    function show_current_page() {
      ...
      // wrap content in hidden class to be faded in
      html = '<div class="hidden"; style="display:none">' + html + '</div>';
      display_element.innerHTML = html;

      // fade in
      $(document).ready(function() {
          $('div.hidden').fadeIn(trial.fade_duration);
      });
    ...
    var after_response = function(info) {
      ...
      jsPsych.pluginAPI.setTimeout(function() {
        ...
        // check if key is forwards or backwards and update page after minimum duration
